"""
U-Net architecture for DDPM with masked conditioning.
Adapted from reference code for 3-channel CIFAR-10.
"""
import torch
import torch.nn as nn
import torch.nn.functional as F
from einops import rearrange
from ..utils.time_emb import DiscreteTimeEmbedding
...
class UNetDDPM(nn.Module):
    """
    U-Net for DDPM with masked conditioning.
    Input: [x_t, sparse_input, mask] concatenated along channel dimension.
    ...
    def __init__(self, dim=128, image_size=32, dim_multiply=(1, 2, 4, 4),
                 channel=3, num_res_blocks=2, attn_resolutions=(16,), dropout=0.1, groups=32):
        super().__init__()
        self.dim = dim
        ...
        # Time embedding
        self.time_embedding = DiscreteTimeEmbedding(dim, self.time_emb_dim)
